...
function Registors() {
  ...
  return (
    ...
    <li className="text-green-600 font-black"><NavLink to={'/Admin/registers'}>Registers</NavLink></li>
  </ul>
        </div>

        {/* Main Content */}
        <div className="flex-1 overflow-x-auto">
          <h1 className="text-white font-black mb-4 text-base sm:text-xl text-left ">Registors</h1>
            ...
            <table className="w-full rounded-lg overflow-hidden bg-white/40 backdrop-blur-lg">
              ...
              <tbody className="divide-y divide-green-900">
                {registors && registors.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="5" className="text-center py-6 text-white font-semibold">No registrants found.</td>
                  </tr>
                )}
              </tbody>
            </table>
